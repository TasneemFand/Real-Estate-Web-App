  ...
  return (
    <div className="flex items-end">
      <Popover>
        ...
        <PopoverContent className="mt-1 max-h-60 w-auto overflow-auto rounded-md bg-white p-0 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
          {localesAndNames.map(({ locale, name }) => {
            ...
            return (
              <div
                ...
                className={cn(
                  ` w-auto cursor-pointer select-none px-4 py-2  hover:bg-zinc-200`
                )}
              >
                <span
                  className={cn(
